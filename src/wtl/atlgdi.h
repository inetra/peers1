...
// Bitmap Functions
	...
	BOOL BitBlt(RECT* prcDest, HDC hSrcDC, POINT* pptSrc, DWORD dwRop)
	{
		int cxWidth = prcDest->right - prcDest->left;
		int cyHeight = prcDest->bottom - prcDest->top;
		return BitBlt(prcDest->left, prcDest->top, cxWidth, cyHeight, hSrcDC, pptSrc->x, pptSrc->y, dwRop);
	}
