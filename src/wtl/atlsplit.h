...
// Implementation - internal helpers
	...
	void DrawGhostBar()
	{
		// PATCHED-BEGIN: The next lines were patched by me. Alex.
		CRect rect;
		// PATCHED-END
		if(GetSplitterBarRect(&rect))
		{
			...
			// PATCHED-BEGIN: The next lines were patched by me. Alex.
			::MapWindowPoints(pT->m_hWnd, HWND_DESKTOP, (LPPOINT) &rect, 2);
			CRect windowRect;
			pT->GetWindowRect(windowRect);
			rect.OffsetRect(-windowRect.left, -windowRect.top);
			// PATCHED-END
