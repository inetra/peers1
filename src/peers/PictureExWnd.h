...
/////////////////////////////////////////////////////////////////////////////
// CPictureExWnd
class CPictureExWnd : public CWindowImpl<CPictureExWnd, CButton>, protected HttpConnectionListener
{
public:
...
public:
	void LoadAdRiverXMLBanner(const string& sid, const string& sz, const string& bn, const string& bt, const string& pz);
	void UnLoadAdRiverXMLBanner();
...
protected:
	...
	string ar_pz;
	string ar_rnd;
	string m_downloaderData;
	string banner_cgihref;
	string banner_zero_comppath;
	HGLOBAL bannerData;
	DWORD bannerDataLength;
	...
	void on(HttpConnectionListener::Redirected, HttpConnection*, const string&) throw();
	void freeBannerData();
};
