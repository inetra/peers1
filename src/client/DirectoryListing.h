...
#pragma warning (default : 4505) // [+] Drakon
...
public:
	...
	public:
        ...
        class Directory : public FastAlloc<Directory>, public Flags {
	public:
...
private:
	friend class ListLoader;
        ...
        QueueManager::TTHSet queued; // !SMT!-UI
        bool isTTHQueued(const TTHValue& tth) const { return queued.find(tth) != queued.end(); } // !SMT!-UI
...
/**
 * @file
 * $Id: DirectoryListing.h,v 1.1.1.1 2007/09/27 13:21:19 alexey Exp $
 */
