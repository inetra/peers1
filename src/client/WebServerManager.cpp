...
string WebServerManager::getLoginPage(){
	...
	pagehtml += "<head>";
	pagehtml += "    	<title>Peers webserver - Login Page</title>";   
	pagehtml += "		<meta http-equiv='Content-Type' content='text/html; charset=windows-1251' />";
    ...
    pagehtml += "<h1>Peers Webserver</h1>";
    ...
    pagehtml += "		2007 | Peers Development Team | <a href='http://www.cn.ru/peers'>Peers</a>";
    pagehtml += "	</div>";
    pagehtml += "</div>";                                
    pagehtml += "</body>";
    pagehtml += "</html>";
...
string WebServerManager::getPage(const string& file, const string& IP) {
    ...
    pagehtml += "<html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en'>";
    pagehtml += "<head>";
    pagehtml += "    <title>FlyLinkDC++ webserver</title>";
    pagehtml += "	 <meta http-equiv='Content-Type' content='text/html; charset=windows-1251' />";
    pagehtml += "    <meta http-equiv='pragma' content='no-cache'>";
    pagehtml += "    <meta http-equiv='cache-control' content='no-cache, must-revalidate'>";
    pagehtml += "	 <link rel='stylesheet' href='http://www.apexdc.net/css/webserver.css' type='text/css' title='Default styl' media='screen' />";
	...
	switch(page->id){
		case INDEX: {
			...
			pagehtml+="<br />&nbsp;Welcome to the Peers Webserver";
			break;
		}
