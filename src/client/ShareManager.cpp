...
".ts" 
/*
Добавьте в шаблон поиска видеофайлов расширение .ts
дело в том, что HDTV-видео пакуется в в transport stream контейнер (.ts). И когда я с помощью поиска ищу HDTV фильмы (задав размер не менее 3 гиг), выдается только ужатые в mpeg4 рипы mkv, mp4, avi. А неужатый ts игноруется sad.gif
*/
};
