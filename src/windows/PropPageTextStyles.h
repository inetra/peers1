...
class PropPageTextStyles: 
  public PeersPropertyPage<IDD_TEXT_STYLES>, 
  public PropPageImpl<PropPageTextStyles,5>
{
public:
	PropPageTextStyles() { 
		fg = 0;
	...
	BEGIN_MSG_MAP(PropPageTextStyles)
		...
		COMMAND_ID_HANDLER(IDC_BAN_COLOR, onBanColor) // !necros!
		COMMAND_ID_HANDLER(IDC_DUPE_COLOR, onDupeColor) // !necros!
	...
	LRESULT onBanColor(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/); // !necros!
	LRESULT onDupeColor(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/); // !necros!
