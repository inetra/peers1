...
class ADLSearchFrame : 
  public MDITabChildWindowImpl<ADLSearchFrame, IDR_ADLSEARCH>, 
...
public:
	...
	// Base class typedef
	typedef MDITabChildWindowImpl<ADLSearchFrame, IDR_ADLSEARCH> baseClass;
...
/**
 * @file
 * $Id: ADLSearchFrame.h,v 1.4 2008/03/10 07:42:28 alexey Exp $
 */
