...
class OperaColorsPage : 
  public PeersPropertyPage<IDD_OPERACOLORS>, 
  public PropPageImpl<OperaColorsPage,7>
{
public:
	OperaColorsPage() {
		title = _tcsdup((TSTRING(SETTINGS_APPEARANCE) + _T('\\') + TSTRING(SETTINGS_OPERACOLORS)).c_str());
		SetTitle(title);
	...
	void updateProgress() {
		...
		::EnableWindow(::GetDlgItem(m_hWnd, IDC_TOP_SPEED), stealthyStyle);
		::EnableWindow(::GetDlgItem(m_hWnd, IDC_SPEED_STR), stealthyStyle);
		::EnableWindow(::GetDlgItem(m_hWnd, IDC_KBPS), stealthyStyle);
		::EnableWindow(::GetDlgItem(m_hWnd, IDC_TOP_UP_SPEED), stealthyStyle);
		::EnableWindow(::GetDlgItem(m_hWnd, IDC_SPEED_UP_STR), stealthyStyle);
		::EnableWindow(::GetDlgItem(m_hWnd, IDC_KBPS2), stealthyStyle);
...
/**
 * @file
 * $Id: OperaColorsPage.h,v 1.6 2008/03/10 07:30:34 alexey Exp $
 */
