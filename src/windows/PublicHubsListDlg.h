...
public:
	...
	LRESULT onInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/) {
		...
		//[+] PPA
		::EnableWindow(GetDlgItem(IDC_LIST_DESC), FALSE);
		::EnableWindow(GetDlgItem(IDC_LIST_ADD), FALSE);
		::EnableWindow(GetDlgItem(IDC_LIST_UP), FALSE);
		::EnableWindow(GetDlgItem(IDC_LIST_DOWN), FALSE);
		::EnableWindow(GetDlgItem(IDC_LIST_EDIT), FALSE);
		::EnableWindow(GetDlgItem(IDC_LIST_REMOVE), FALSE);
		::EnableWindow(GetDlgItem(IDC_LIST_LIST), FALSE);
		::EnableWindow(GetDlgItem(IDC_LIST_REMOVE), FALSE);
		::EnableWindow(GetDlgItem(IDC_LIST_EDIT_BOX), FALSE);
...
/**
* @file
* $Id: PublicHubsListDlg.h,v 1.2 2008/03/10 07:51:06 alexey Exp $
*/
