...
LRESULT LogPage::onInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
	...
	PropPage::read(items);
	PropPage::readCheckBoxList(listItems, GetDlgItem(IDC_LOG_OPTIONS));
...
void LogPage::write()
{
	...
	PropPage::writeCheckBoxList(listItems, GetDlgItem(IDC_LOG_OPTIONS));
...
/**
 * @file
 * $Id: LogPage.cpp,v 1.5 2008/03/10 06:34:23 alexey Exp $
 */
