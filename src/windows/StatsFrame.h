...
class StatsFrame : 
  public MDITabChildWindowImpl<StatsFrame, IDR_NET_STATS>,
...
public:
	...
	typedef MDITabChildWindowImpl<StatsFrame, IDR_NET_STATS> baseClass;
...
/**
 * @file
 * $Id: StatsFrame.h,v 1.5 2008/03/10 07:44:31 alexey Exp $
 */
