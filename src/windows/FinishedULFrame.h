...
class FinishedULFrame : public FinishedFrameBase<FinishedULFrame, ResourceManager::FINISHED_UPLOADS, IDC_FINISHED_UL, IDI_PEERS_FINISHED_UPLOADS>
{
public:
	FinishedULFrame() {
		upload = true;
	...
	DECLARE_FRAME_WND_CLASS_EX(_T("FinishedULFrame"), IDI_PEERS_FINISHED_UPLOADS, 0, COLOR_3DFACE);
...
private:
	...
	void on(RemovedUl, FinishedItem* entry) throw() { 
...
/**
 * @file
 * $Id: FinishedULFrame.h,v 1.2 2007/11/29 11:52:04 alexey Exp $
 */
