...
public:
	...
	BEGIN_MSG_MAP(TreePropertySheet)
		...
		MESSAGE_HANDLER(WM_USER_INITDIALOG, onUserInitDialog)
	...
	LRESULT onUserInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& bHandled);
...
protected:
	...
	virtual void fillTree();
        ...
        virtual bool isVisiblePage(int /*pageIndex*/) { return true; }
        virtual bool allowChange(NMTREEVIEW*) { return true; }
        virtual int getItemImageIndex(int page) { return page; }
...
/**
* @file
* $Id: TreePropertySheet.h,v 1.6 2008/03/10 07:44:31 alexey Exp $
*/
