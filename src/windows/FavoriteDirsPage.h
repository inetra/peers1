...
class FavoriteDirsPage : 
  public PeersPropertyPage<IDD_FAVORITE_DIRSPAGE>, 
  public PropPageImpl<FavoriteDirsPage,16>
{
public:
	FavoriteDirsPage() {
...
/**
 * @file
 * $Id: FavoriteDirsPage.h,v 1.5 2008/03/10 07:12:42 alexey Exp $
 */
